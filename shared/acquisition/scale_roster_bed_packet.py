...
OFFICIAL_BEDS = [
    OfficialBedFact(
        fact_id="christiana-newark-licensed-906",
        entity_id="data-mcp:facility:official:christianacare:christiana-hospital",
        source_id="christianacare-about",
        measure_id="bed_count.licensed",
        extraction_pattern=r"licensed\W+beds\W+Newark\W+Campus\W+(?P<value>906)",
        period="2023",
        basis="licensed",
        row_locator="2023 Statistics: Licensed beds Newark Campus: 906",
    ),
    OfficialBedFact(
        fact_id="christiana-wilmington-licensed-321",
        entity_id="data-mcp:facility:official:christianacare:wilmington-hospital",
        source_id="christianacare-about",
        measure_id="bed_count.licensed",
        extraction_pattern=r"Wilmington\W+Campus\W+(?P<value>321)",
        period="2023",
        basis="licensed",
        row_locator="2023 Statistics: Licensed beds Wilmington Campus: 321",
    ),
    OfficialBedFact(
        fact_id="christiana-cecil-licensed-109",
        entity_id="data-mcp:facility:ccn:210032",
        source_id="christianacare-about",
        measure_id="bed_count.licensed",
        extraction_pattern=r"Cecil\W+County\W+Campus\W+(?P<value>109)",
        period="2023",
        basis="licensed",
        row_locator="2023 Statistics: Licensed beds Cecil County Campus: 109",
    ),
    OfficialBedFact(
        fact_id="union-official-103",
        entity_id="data-mcp:facility:ccn:210032",
        source_id="christianacare-union",
        measure_id="bed_count.official_unspecified",
        extraction_pattern=r"(?P<value>103)\W+bed\W+facility",
        period="current page",
        basis="official unspecified",
        row_locator="Union Hospital bullet: 103-bed facility",
    ),
    OfficialBedFact(
        fact_id="west-grove-official-10",
        entity_id="data-mcp:facility:official:christianacare:west-grove",
        source_id="christianacare-west-grove",
        measure_id="bed_count.official_unspecified",
        extraction_pattern=r"(?P<value>10)\W+inpatient\W+beds",
        period="2025-08-13",
        basis="official inpatient, otherwise unspecified",
        row_locator="opening announcement: 10 inpatient beds",
    ),
    OfficialBedFact(
        fact_id="episcopal-official-139",
        entity_id="data-mcp:facility:official:temple-health:episcopal-campus",
        source_id="temple-episcopal",
        measure_id="bed_count.licensed",
        extraction_pattern=r"(?P<value>139)\W+licensed\W+beds",
        period="current page",
        basis="licensed",
        row_locator="About section: 139 licensed beds",
    ),
    OfficialBedFact(
        fact_id="chestnut-official-148",
        entity_id="data-mcp:facility:ccn:390026",
        source_id="temple-chestnut-hill",
        measure_id="bed_count.official_unspecified",
        extraction_pattern=r"(?P<value>148)\W+bed",
        period="current page",
        basis="official unspecified",
        row_locator="About section: 148-bed hospital",
    ),
    OfficialBedFact(
        fact_id="cooper-camden-licensed-663",
        entity_id="data-mcp:facility:ccn:310014",
        source_id="cooper-camden-2025",
        measure_id="bed_count.licensed",
        extraction_pattern=r"(?P<value>663)\W+licensed\W+beds",
        period="Q1 2025",
        basis="licensed",
        row_locator="Fast Facts: 663 licensed beds",
    ),
    OfficialBedFact(
        fact_id="cooper-cape-licensed-242",
        entity_id="data-mcp:facility:ccn:310011",
        source_id="cooper-cape-2025",
        measure_id="bed_count.licensed",
        extraction_pattern=r"(?P<value>242)\W+licensed\W+beds",
        period="Q1 2025",
        basis="licensed",
        row_locator="Fast Facts: 242 licensed beds",
    ),
    OfficialBedFact(
        fact_id="lankenau-official-370",
        entity_id="data-mcp:facility:ccn:390195",
        source_id="main-line-lankenau",
        measure_id="bed_count.licensed",
        extraction_pattern=r"licensed\W+beds\W+(?P<value>370)",
        period="FY25",
        basis="licensed",
        row_locator="Hospital statistics: LICENSED BEDS 370",
    ),
    OfficialBedFact(
        fact_id="bryn-mawr-official-284",
        entity_id="data-mcp:facility:ccn:390139",
        source_id="main-line-bryn-mawr",
        measure_id="bed_count.licensed",
        extraction_pattern=r"licensed\W+beds\W+(?P<value>284)",
        period="FY25",
        basis="licensed",
        row_locator="Hospital statistics: LICENSED BEDS 284",
    ),
    OfficialBedFact(
        fact_id="paoli-official-261",
        entity_id="data-mcp:facility:ccn:390153",
        source_id="main-line-paoli",
        measure_id="bed_count.licensed",
        extraction_pattern=r"licensed\W+beds\W+(?P<value>261)",
        period="FY25",
        basis="licensed",
        row_locator="Hospital statistics: LICENSED BEDS 261",
    ),
    OfficialBedFact(
        fact_id="riddle-official-243",
        entity_id="data-mcp:facility:ccn:390222",
        source_id="main-line-riddle",
        measure_id="bed_count.licensed",
        extraction_pattern=r"licensed\W+beds\W+(?P<value>243)",
        period="FY25",
        basis="licensed",
        row_locator="Hospital statistics: LICENSED BEDS 243",
    ),
]
...
def _pa_state_row(
    ...
    *,
    ...
    system_slug: str = "jefferson-health",
) -> StateBedRow:
    candidate = CANDIDATE_BY_NAME.get(candidate_name or "")
    resolved_system_slug = candidate.system_slug if candidate is not None else system_slug
    return StateBedRow(
        entity_id=f"data-mcp:facility:state:pa:report-2024:{_slug(source_name)}",
        candidate_entity_id=candidate.entity_id if candidate is not None else "",
        system_slug=resolved_system_slug,
        source_id="pa-hospital-report-2024-1b" if specialty else "pa-hospital-report-2024-1a",
        source_name=source_name,
        match_field="FACILITY NAME",
        match_value=source_name,
        licensed_field="LICENSED BEDS**" if specialty else "LICENSED BEDS",
        staffed_field="BEDS SET UP AND STAFFED",
    )


def _nj_state_row(candidate_name: str, source_name: str, facility_id: str) -> StateBedRow:
    candidate = CANDIDATE_BY_NAME[candidate_name]
    return StateBedRow(
        entity_id=candidate.entity_id,
        candidate_entity_id=candidate.entity_id,
        system_slug=candidate.system_slug,
        source_id="nj-acute-care-current",
        source_name=source_name,
        match_field="FacID",
        match_value=facility_id,
        licensed_field="Lic_Beds_Slots",
        state_license_field="LIC#",
    )


STATE_BED_ROWS = (
    _pa_state_row("Jefferson Abington Hospital", "ABINGTON MEMORIAL HOSPITAL"),
    _pa_state_row("Jefferson Einstein Montgomery Hospital", "EINSTEIN MEDICAL CENTER MONTGOMERY"),
    _pa_state_row("Jefferson Einstein Philadelphia Hospital", "ALBERT EINSTEIN MEDICAL CENTER"),
    _pa_state_row("Jefferson Lansdale Hospital", "LANSDALE HOSPITAL"),
    _pa_state_row("Thomas Jefferson University Hospital", "THOMAS JEFFERSON UNIVERSITY HOSPITAL"),
    _pa_state_row(None, "JEFFERSON HEALTH NORTHEAST"),
    _pa_state_row("Temple University Hospital", "TEMPLE UNIVERSITY HOSPITAL"),
    _pa_state_row("Temple Health - Chestnut Hill Hospital", "TEMPLE HEALTH CHESTNUT HILL HOSPITAL"),
    _pa_state_row("Hospital of the University of Pennsylvania", "HOSPITAL OF THE UNIVERSITY OF PENNSYLVANIA"),
    _pa_state_row("Penn Presbyterian Medical Center", "PENN PRESBYTERIAN MEDICAL CENTER"),
    _pa_state_row("Chester County Hospital", "CHESTER COUNTY HOSPITAL"),
    _pa_state_row("Lancaster General Hospital", "LANCASTER GENERAL HOSPITAL"),
    _pa_state_row(
        "Pennsylvania Hospital",
        "PENNSYLVANIA HOSPITAL OF THE UNIVERSITY OF PENNSYLVANIA HEALTH SYSTEM",
    ),
    _pa_state_row("Lankenau Medical Center", "MAIN LINE HOSPITAL LANKENAU MEDICAL CENTER"),
    _pa_state_row("Bryn Mawr Hospital", "MAIN LINE HOSPITAL BRYN MAWR"),
    _pa_state_row("Paoli Hospital", "MAIN LINE HOSPITAL PAOLI"),
    _pa_state_row("Riddle Hospital", "RIDDLE MEMORIAL HOSPITAL"),
    _pa_state_row(
        "Bryn Mawr Rehabilitation Hospital",
    ...
    _nj_state_row("Jefferson Cherry Hill Hospital", "JEFFERSON CHERRY HILL HOSPITAL (NJ10401)", "NJ10401"),
    _nj_state_row("Jefferson Stratford Hospital", "JEFFERSON STRATFORD HOSPITAL (NJ10403)", "NJ10403"),
    _nj_state_row(
        "Jefferson Washington Township Hospital",
        "JEFFERSON WASHINGTON TOWNSHIP HOSPITAL (NJ10802-1)",
        "NJ10802-1",
    ),
    _nj_state_row("Cooper University Hospital", "COOPER UNIVERSITY HOSPITAL (NJ10402)", "NJ10402"),
    _nj_state_row(
        "Cooper University Hospital Cape Regional",
...
def acquisition_spec() -> AcquisitionSpec:
    ...
    for row in STATE_BED_ROWS:
        if not row.source_id.startswith("pa-"):
            continue
        unresolved = []
        if row.candidate_entity_id:
            unresolved.append(
                {
                    "identifier_type": "candidate_entity_id",
                    "identifier": row.candidate_entity_id,
                }
            )
        entities.append(
            EntitySpec(
                ...
                identity_conflicts=[{"type": "name_only_candidate_relationship", "status": "open"}],
        ...
        for measure_id, field, basis in (
            ...
            facts.append(
                FactSpec(
                    ...
                    match_basis=(
                        "Exact state-reported facility name identifies this PA source-local entity only; "
                        "the candidate relationship remains unresolved."
                        if row.source_id.startswith("pa-")
                        else "Exact state facility identifier; no name-only entity merge."
                    ),
    ...
    conflict_rows = [
        ...
        ConflictSpec(
            ...
            entity_ids=[
                ...
                "data-mcp:facility:state:pa:report-2024:temple-university-hospital",
            ],
            fact_ids=[
        ...
        ConflictSpec(
            ...
            entity_ids=[
                ...
                "data-mcp:facility:state:pa:report-2024:temple-health-chestnut-hill-hospital",
            ],
            fact_ids=[
